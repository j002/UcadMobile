...
public class TrainingschoolRealmProxy extends Trainingschool
    ...
    public static Table initTable(ImplicitTransaction transaction) {
        if (!transaction.hasTable("class_Trainingschool")) {
            Table table = transaction.getTable("class_Trainingschool");
        ...
        return transaction.getTable("class_Trainingschool");
    }
    ...
    public static void validateTable(ImplicitTransaction transaction) {
        if (transaction.hasTable("class_Trainingschool")) {
            ...
            for (String fieldName : getFieldNames()) {
                ...
                if (index == -1) {
                    throw new RealmMigrationNeededException(transaction.getPath(), "Field '" + fieldName + "' not found for type Trainingschool");
                }
            ...
            throw new RealmMigrationNeededException(transaction.getPath(), "The Trainingschool class is missing from the schema for this Realm.");
        }
    }

    public static String getTableName() {
        return "class_Trainingschool";
    }
    ...
    public static Trainingschool createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        Trainingschool obj = realm.createObject(Trainingschool.class);
        if (!json.isNull("id")) {
    ...
    public static Trainingschool createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        Trainingschool obj = realm.createObject(Trainingschool.class);
        reader.beginObject();
    ...
    public static Trainingschool copyOrUpdate(Realm realm, Trainingschool object, boolean update, Map<RealmObject,RealmObjectProxy> cache) {
    ...
    public static Trainingschool copy(Realm realm, Trainingschool newObject, boolean update, Map<RealmObject,RealmObjectProxy> cache) {
        Trainingschool realmObject = realm.createObject(Trainingschool.class);
    ...
    static Trainingschool update(Realm realm, Trainingschool realmObject, Trainingschool newObject, Map<RealmObject, RealmObjectProxy> cache) {
        realmObject.setId(newObject.getId());
        realmObject.setName(newObject.getName() != null ? newObject.getName() : "");
        realmObject.setLatgeo(newObject.getLatgeo());
        realmObject.setLonggeo(newObject.getLonggeo());
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("Trainingschool = [");
    ...
    public boolean equals(Object o) {
        ...
        TrainingschoolRealmProxy aTrainingschool = (TrainingschoolRealmProxy)o;

        String path = realm.getPath();
        String otherPath = aTrainingschool.realm.getPath();
        if (path != null ? !path.equals(otherPath) : otherPath != null) return false;;

        String tableName = row.getTable().getName();
        String otherTableName = aTrainingschool.row.getTable().getName();
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null) return false;

        if (row.getIndex() != aTrainingschool.row.getIndex()) return false;
