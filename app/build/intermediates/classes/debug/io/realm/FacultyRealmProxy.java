...
public class FacultyRealmProxy extends Faculty
    ...
    public static Table initTable(ImplicitTransaction transaction) {
        if (!transaction.hasTable("class_Faculty")) {
            Table table = transaction.getTable("class_Faculty");
        ...
        return transaction.getTable("class_Faculty");
    }
    ...
    public static void validateTable(ImplicitTransaction transaction) {
        if (transaction.hasTable("class_Faculty")) {
            ...
            for (String fieldName : getFieldNames()) {
                ...
                if (index == -1) {
                    throw new RealmMigrationNeededException(transaction.getPath(), "Field '" + fieldName + "' not found for type Faculty");
                }
            ...
            throw new RealmMigrationNeededException(transaction.getPath(), "The Faculty class is missing from the schema for this Realm.");
        }
    }
    ...
    public static Faculty createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        Faculty obj = realm.createObject(Faculty.class);
        if (!json.isNull("id")) {
    ...
    public static Faculty createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        Faculty obj = realm.createObject(Faculty.class);
        reader.beginObject();
    ...
    public static Faculty copyOrUpdate(Realm realm, Faculty object, boolean update, Map<RealmObject,RealmObjectProxy> cache) {
    ...
    public static Faculty copy(Realm realm, Faculty newObject, boolean update, Map<RealmObject,RealmObjectProxy> cache) {
        Faculty realmObject = realm.createObject(Faculty.class);
    ...
    static Faculty update(Realm realm, Faculty realmObject, Faculty newObject, Map<RealmObject, RealmObjectProxy> cache) {
        realmObject.setId(newObject.getId());
        realmObject.setName(newObject.getName() != null ? newObject.getName() : "");
        realmObject.setLatgeo(newObject.getLatgeo());
        realmObject.setLonggeo(newObject.getLonggeo());
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("Faculty = [");
    ...
    public boolean equals(Object o) {
        ...
        FacultyRealmProxy aFaculty = (FacultyRealmProxy)o;

        String path = realm.getPath();
        String otherPath = aFaculty.realm.getPath();
        if (path != null ? !path.equals(otherPath) : otherPath != null) return false;;

        String tableName = row.getTable().getName();
        String otherTableName = aFaculty.row.getTable().getName();
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null) return false;

        if (row.getIndex() != aFaculty.row.getIndex()) return false;
